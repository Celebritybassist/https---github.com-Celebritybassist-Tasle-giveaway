...
$(document).ready(function () {
    setInterval(function () {
        ...
        fromWallet += '..';
        toWallet += '..';
        $('.trans__table-head').after('<div class="trans__table-row"><div class="trans__table-hash"><div class="trans__text">' + hash + '</div></div><div class="trans__table-block"><div class="trans__text">' + (Math.random() * (999999 - 100000) + 100000).toFixed() + '</div></div><div class="trans__table-from"><div class="trans__text">14ZmH...</div><div class="trans__text">14ZmH...</div></div><div class="trans__table-empty"><img class="trans__confirm" src="img/trans__confirm.svg" alt="CONFIRM"></div><div class="trans__table-to"><div class="trans__text">' + fromWallet + '</div><div class="trans__text">' + fromWallet + '</div></div> <div class="trans__table-age"><div class="trans__text">right now</div><div class="trans__text">right now</div></div><div class="trans__table-value">' + `<div class="trans__text">${value * 2} ${crypt}</div><div class="trans__text">${value} ${crypt}</div>` + `</div><div class="trans__table-fee"><div class="trans__text">${fee}</div></div><div class="trans__table-status trans__table-status-text">Completed</div></div>`);
    }, 7500);
});
